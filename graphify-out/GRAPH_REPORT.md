# Graph Report - trusting-perlman-d52b73  (2026-05-27)

## Corpus Check
- 131 files · ~1,378,525 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 984 nodes · 1963 edges · 50 communities (37 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `721ae129`
...
- `handleEvent()` --calls--> `redis()`  [EXTRACTED]
  app/api/line/webhook/route.ts → lib/memory/redis.ts

## Communities (50 total, 13 thin omitted)

### Community 1 - "Community 1"
Cohesion: 0.12
Nodes (31): parsePostbackData(), taskCheckinFlex(), handlePostback(), buildMorningBriefing(), fetchNews(), fetchWeather(), NewsStory, shouldFireBriefingNow() (+23 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (57): Body, POST(), respondToImage(), respondToOtherMedia(), respondToText(), handleAdminCommand(), handleMyId(), classify() (+49 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (53): Body, POST(), Body, POST(), cancelSchedule(), localTimeToUtcCron(), qstash(), scheduleOneShot() (+45 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (51): briefingFlex(), CalendarEventRow, calendarEventsFlex(), confirmCancelFlex(), gmailResultsFlex(), GmailRow, listItemsFlex(), newsFlex() (+43 more)
...
Cohesion: 0.07
Nodes (40): GET(), redisCreds(), checkRateLimit(), getLimiter(), addToAllowlist(), addToPending(), adminNotifKey(), approvePending() (+32 more)
...
Cohesion: 0.11
Nodes (34): hasUpstashVector(), ExtractedFact, Schema, appendArchive(), ArchivedSummary, embedText(), key(), listArchive() (+26 more)
...
Cohesion: 0.09
Nodes (29): applyMigrations(), DEFAULTS, getSettings(), key(), MIGRATIONS, StoredSettings, updateSettings(), UserSettings (+21 more)

### Community 14 - "Community 14"
Cohesion: 0.18
Nodes (23): hasGoogleOAuth(), ConnectPage(), Account, AccountsBlob, accountsKey(), addAccount(), completeOAuth(), connectLinkKey() (+15 more)

### Community 15 - "Community 15"
Cohesion: 0.13
Nodes (17): GET(), escapeHtml(), htmlPage(), AFFIRMATIVE, AffirmDecision, appendPending(), clearPending(), CreateCalendarEventAction (+9 more)
...
Cohesion: 0.11
Nodes (13): SendEmailAction, buildContactsTools(), PersonShape, READ_SCOPES, WRITE_SCOPES, buildDocsTools(), buildGmailInboxTools(), Headers (+5 more)
...
## Knowledge Gaps
- **443 isolated node(s):** `config`, `config`, `name`, `version`, `private` (+438 more)
...
- **Why does `redis()` connect `Community 6` to `Community 1`, `Community 2`, `Community 3`, `Community 9`, `Community 13`, `Community 14`, `Community 15`, `Community 20`, `Community 23`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `env` connect `Community 3` to `Community 1`, `Community 2`, `Community 4`, `Community 6`, `Community 9`, `Community 14`, `Community 28`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `loadFacts()` connect `Community 9` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 13`?**
